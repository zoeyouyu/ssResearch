...
```{r}
seg1 = smoothed.df %>% filter(id <= top_3_peaks_indices[1])
seg1.test = cpt.meanvar(seg1$pressure)
...
```{r}
seg2 = smoothed.df %>% filter(id >= point1, id <= top_3_peaks_indices[2])
seg2.test = cpt.meanvar(seg2$pressure)
