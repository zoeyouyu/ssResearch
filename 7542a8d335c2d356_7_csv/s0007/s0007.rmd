...
```{r}
getwd()
setwd("C:/Users/Pluie/Desktop/SS research/7542a8d335c2d356_7_csv/s0007")
...
See R code below:
#### CHAPTER NAME: SHOW ME THE CHANGE 
###### A function to mutate a pressure `change` column
```{r}
baseline = function(relaxdata){
...
x = findpeaks(pSignal, npeaks=5, threshold=4)
points(x, pSignal[x], pch=20, col="red")
