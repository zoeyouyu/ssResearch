...
```{r}
squeeze_and_hold_start = seq(3, n_squeeze_and_hold+2, 1)*2-1

# Shift the starting time of each contraction in exercise `Squeeze and hold` 10 points forward (so the graph looks nicer)
mypoints[squeeze_and_hold_start] = mypoints[squeeze_and_hold_start] - 10
...
## Let's have a look at each individual event(could be a contraction/fast rapid/knack/endurance) !!!!
